...
public class UtilesDB {
    ...
    public static final String DEF_USER_MYSQL = "usuario";
    public static final String DEF_PASS_MYSQL = "usuario";
    private static final String DEF_CONS_MYSQL = "String.format(DEF_FORM_MYSQL, DEF_PROT_MYSQL, DEF_HOST_MYSQL, DEF_PORT_MYSQL, DEF_BDAM_MYSQL, DEF_USER_MYSQL, DEF_PASS_MYSQL)";
    ...
    public static final Connection obtenerConexion() throws SQLException {
        ...
        if(new File(FICHERO_PRP).exists()){
            ...
            System.out.println("ERROR: Fichero propiedades BD NO ENCONTRADO");
    ...
    public static final Connection obtenerConexion(Properties prp) throws SQLException {
        String cadenaConexion = String.format(DEF_FORM_MYSQL, prp.getProperty(PRP_PROT, DEF_PROT_MYSQL), 
                prp.getProperty(PRP_HOST,DEF_HOST_MYSQL), prp.getProperty(PRP_PORT, DEF_PORT_MYSQL),
                prp.getProperty(PRP_DBAM, DEF_DBAM_MYSQL), prp.getProperty(PRP_USER, DEF_USER_MYSQL),
